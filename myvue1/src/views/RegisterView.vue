<template>
    <div>
        <div
            style="width: 400px; height: 400px; margin: 150px auto; background-color: rgba(122, 153, 206, 0.5); border-radius: 10px;">
            <div
                ...
                <el-form :model="user">
                    ...
                    <el-form-item>
                        <el-button style="width: 80%; margin-top: 10px;" type="primary"
                            v-loading.fullscreen.lock="fullscreenLoading" @click="register()">注册</el-button>
